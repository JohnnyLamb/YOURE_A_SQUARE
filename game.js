...
$.playground().registerCallback(function(){
  var enemyValue = Math.ceil(Math.random()*10) - 1;
...
$(document).keydown(function(e){
  if(e.keyCode === 32){
      ...
      $("#playerMissileLayer").addSprite(name, {posx: playerposx + playerWidth, posy: playerposy, width: playerWidth/4,height: playerHeight/4});
